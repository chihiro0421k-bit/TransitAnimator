...
// 駅データ（今後JSON化）
const stations = {
    "福知山": { lat: 35.2966, lng: 135.1268 },
    "綾部": { lat: 35.3020, lng: 135.2580 },
    "和知": { lat: 35.2608, lng: 135.4054 },
    "園部": { lat: 35.1024, lng: 135.4706 },
    "亀岡": { lat: 35.0136, lng: 135.5827 },
    "京都": { lat: 35.0116, lng: 135.7681 },
    "大阪": { lat: 34.7025, lng: 135.4959 }
};
// マーカー表示
